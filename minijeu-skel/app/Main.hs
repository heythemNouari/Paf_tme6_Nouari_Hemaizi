...
loadVirus rdr path tmap smap = do
  ...
  let sprite = S.defaultScale $ S.addImage S.createEmptySprite $ S.createImage (TextureId "virus") (S.mkArea 0 0 80 80)
...
main = do
  ...
  (tmap2, smap2) <- loadVirus renderer "assets/virus.png" tmap' smap'
